                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: SvgPicture.asset(
                                    'assets/images/image-resizer-svgrepo-com-removebg-preview.svg',
                                    width: 48.0,
                                    height: 48.0,
                                    fit: BoxFit.cover,
                                  ),
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              child: QuizSetsWidget(
                                key: Key(
                                    'Key3m8_${listViewIndex}_of_${listViewQuizSetRecordList.length}'),
                                title: listViewQuizSetRecord.quizName,
                                descripcion: listViewQuizSetRecord.description,
                                totalsQuestions:
                                    listViewQuizSetRecord.totalQuestions,
                                durationQ:
                                    listViewQuizSetRecord.duration / 60000,
                                imageP: listViewQuizSetRecord.coverPhoto,
                              ),
                            ),
                          );
                        },
