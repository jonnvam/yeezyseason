...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF090F13);
  ...
  late Color primaryBtnText = const Color(0xFFDBE2E7);
  late Color lineColor = const Color(0xFF57636C);
  late Color backgroundComponents = const Color(0xFF95A1AC);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF111518);
  late Color secondary = const Color(0xFFFEFEFE);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF191D21);
